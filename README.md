...
<p align="center">
<img src="./assets/img/collection-framework.png"><br>
...
<p align="center">
<img src="./assets/img/collection-framework-methods.png" alt="List interface hierarchy Java"><br>
...
3. Execute o seguinte comando para mudar a URL remota para SSH:
   ...
   ```shell
   git remote set-url origin git@github.com:wallacemillerdias/collections-java-api-2023.git
